...
class PresentViewModel @Inject constructor(var news : NewsFeed) : ViewModel(){
    ...
    private fun transition(view : View, intent : Intent){
        ...
        val placeHolder = view.rootView.findViewById<LinearLayout>(R.id.thumbnail_placeholder)
        ...
        val pairs= mutableListOf(thumbnailPair, titlePair, placeholderPair, toolbarPair, statusPair)
